...
import BUEN_PASTOR.exception.FileStorageException;
import BUEN_PASTOR.exception.MyFileNotFoundException;
...
@Service
public class AlmacenamientoFotoService {
    private FileStorageProperties fileStorageProperties;

    public AlmacenamientoFotoService(FileStorageProperties fileStorageProperties) {
